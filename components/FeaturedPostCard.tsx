...
export const FeaturedPostCard: React.FC<FeaturedPostCardProps> = ({ post, language }) => {
    ...
    return (
        <a href={`#/blog/${post.slug}`} className="block bg-secondary rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-glow hover:-translate-y-2 group md:flex">
            <div className="md:w-1/2 relative w-full aspect-[16/9] md:aspect-auto overflow-hidden">
                 <img 
                    src={post.imageUrl} 
                    alt={title} 
            ...
            <div className="md:w-1/2 p-6 flex flex-col">
                ...
                <p className="text-sm text-dark-text mb-4 flex-grow">
                    {excerpt}
                </p>
